...
def databasesave(entrynum,name,address,mobile_no,room,no_of_days,gdate):
    try:
        ...
        query = "insert into checkin(gentno,gname,gmobile,gaddress,gdays,groomno,ckindate) values(%s,%s,%s,%s,%s,%s,%s)"
        values = (entrynum,name,mobile_no,address,no_of_days,room,gdate)
...
class HOTEL_MANGMENT_checkin:
    ...
    def __init__(self):
        ...
        def bill(self):
            ...
            print("values =",self.name,self.address,self.mobile_no,self.room,self.no_of_days,self.gdate,self.entrynum)
            databasesave(self.entrynum,self.name,self.address,self.mobile_no,self.room,self.no_of_days,self.gdate)
        ...
        self.Label3.place(relx=0.05, rely=0.23, height=47, width=289)
        ...
        self.Label3.configure(text='''NUMBER OF GUEST''')

        self.Entry3 = Entry(self.Frame1)
        self.noguest=StringVar()
        self.Entry3.place(relx=0.47, rely=0.30,height=34, relwidth=0.43)
        ...
        self.Entry3.configure(textvariable=self.noguest)

        self.Message4 = Message(self.Frame1)
        self.Message4.place(relx=0.41, rely=0.30, relheight=0.4, relwidth=0.05)
        ...
        self.Button1.place(relx=0.91, rely=0.30, height=33, width=43)
        ...
        self.Frame2.place(relx=0.03, rely=0.18, relheight=0.47, relwidth=0.93)
...
#####
        ...
        self.Checkbutton2.configure(text='''LUXURY''')
        ...
        self.Checkbutton3.configure(text='''SEMI DELUX''')
        ...
        self.Checkbutton4.configure(text='''GENERAL''')
        ...
        #guest
        # guest = ttk.Label(root,text = 'guest no :')
        # guest_ent = ttk.Entry(root,textvariable = num_var)
        # but1 = ttk.Button(root,text='ok',command=submit)

        # guest.grid(row=0,column=0)
        # guest_ent.grid(row=0,column=1) 
...
#calender
        self.Button4 = Button(self.Frame2)
        self.Button4.place(relx=0.76, rely=0.92, height=27, width=156)
        self.Button4.configure(activebackground="#ffffff")
        self.Button4.configure(activeforeground="#000000")
        self.Button4.configure(background="#ffffff")
        self.Button4.configure(disabledforeground="#bfbfbf")
        ...
        self.Button4.configure(highlightcolor="black")
        self.Button4.configure(pady="0")
        self.Button4.configure(text='''CHECK-IN DATE''')
        self.Button4.configure(command=calexp)
